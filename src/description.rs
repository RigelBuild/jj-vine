...
mod tests {
    ...
    #[test]
    fn top_placement_no_user_content() {
        assert_str_eq!(
            insert_stack_into_description("New stack", "", StackPlacement::Top),
            format!("{START_MARKER}\nNew stack\n{END_MARKER}")
        );
    }

    #[test]
    fn top_placement_reinsert_replaces_existing() {
        assert_str_eq!(
